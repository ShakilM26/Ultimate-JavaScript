...
// ব্রাউজার যখন একটি এইচটিএমএল ফাইল লোড করে, সে DOM-কে একটি ট্রি স্ট্রাকচারে সাজায় যেখানে প্রতিটি ট্যাগ 
// (যেমন: h1, div, p) একেকটি 'নোড' (Node) বা শাখা।
...
// আপনি যখন আপনার প্রজেক্টগুলো (যেমন: Daily Expense ট্র্যাকার বা অটোমেশন টুল) বানাবেন, তখন ইউজারের ইনপুট নেওয়া, 
