...
// 📌 ১. হোয়েস্টিং (Hoisting) কী?
// সংক্ষেপে, জাভাস্ক্রিপ্ট কীভাবে কোড রান করার আগে ভেরিয়েবলগুলোকে "চেনে", সেটাই হলো হোয়েস্টিং।
// জাভাস্ক্রিপ্ট যখন কোনো কোড রান করে, তখন সে পুরো কোডটা একবার পড়ে দেখে। এই সময় সে সব ভেরিয়েবল এবং ফাংশন ডিক্লেয়ারেশনগুলোকে 
// খুঁজে বের করে মেমরিতে জায়গা দেয়। অর্থাৎ, মেমোরিতে আগে থেকে স্টোর করে রাখে।
// অর্থাৎ, যেখানে কোড এক্সিকিউশনের আগে ভেরিয়েবল এবং ফাংশন ডিক্লারেশনগুলোকে তাদের স্কোপের (Scope) শুরুতে নিয়ে যাওয়া হয়। 
// এর ফলে, ভেরিয়েবল বা ফাংশনটি কোডে লেখার আগেই তা ব্যবহার করা সম্ভব হয়। 
// এটাই Hoisting.


// 🌼 var এর ক্ষেত্রে হোয়েস্টিং:
...
// 🌼 let and const এর ক্ষেত্রে হোয়েস্টিং:
// এরাও হোয়েস্টেড হয়, কিন্তু এদেরকে একটি Temporal Dead Zone (TDZ) এ রাখা হয়। অর্থাৎ, ডিক্লেয়ার করার আগে এদের কল করলে জাভাস্ক্রিপ্ট সরাসরি এরর দিবে।
